...
export const ios = {
    ...
    */
    chunkFile: (parentFilePath, chunkDirPath, numChunks) => NativeModule.chunkFile(parentFilePath, chunkDirPath, numChunks),
    /*
    ...
    */
    getUploadStatus: (jobId) => __awaiter(void 0, void 0, void 0, function* () { return (yield NativeModule.getUploadStatus(jobId)) || { state: 'inactive' }; }),
};
export default {
    startUpload,
    cancelUpload,
